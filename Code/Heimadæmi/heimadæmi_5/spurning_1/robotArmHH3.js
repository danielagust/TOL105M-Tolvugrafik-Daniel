/////////////////////////////////////////////////////////////////
//    S�nislausn � d�mi 1 � heimad�mum 5 � T�lvugraf�k
     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 40:	// ni�ur �r
                zDist -= 1.0;
                break;
            case 90:	// z - sn�r st�pli �fram
			    theta[0] = Math.min(180, theta[0]+5);
                break;
            case 88:	// x - sn�r st�pli aftur�bak
			    theta[0] = Math.max(-180, theta[0]-5);
                break;
            case 65:	// a - sn�r ne�ri armi
			    theta[1] = Math.min(80, theta[1]+5);
                break;
            case 83:	// s - sn�r ne�ri armi
			    theta[1] = Math.max(0, theta[1]-5);
                break;
            case 81:	// q - sn�r efri armi
			    theta[2] = Math.min(70, theta[2]+5);
                break;
            case 87:	// w - sn�r efri armi
			    theta[2] = Math.max(0, theta[2]-5);
                break;
            case 69:	// c - sn�r efri armi
			    theta[3] = Math.min(70, theta[3]+5);
                break;
            case 82:	// v - sn�r efri armi
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, rotate(theta[TopArm], 0, 0, 1) );
    topArm();
