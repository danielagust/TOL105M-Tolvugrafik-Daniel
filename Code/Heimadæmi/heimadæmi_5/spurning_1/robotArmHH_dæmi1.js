     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 90:	// z - snýr stöpli áfram
			    theta[0] = Math.min(180, theta[0]+speed);
                break;
            case 88:	// x - snýr stöpli afturábak
			    theta[0] = Math.max(-180, theta[0]-speed);
                break;
            case 65:	// a - snýr neðri armi
			    theta[1] = Math.min(80, theta[1]+speed);
                break;
            case 83:	// s - snýr neðri armi
			    theta[1] = Math.max(-90, theta[1]-speed);
                break;
            case 81:	// q - snýr efri armi
			    theta[2] = Math.min(170, theta[2]+speed);
                break;
            case 87:	// w - snýr efri armi
			    theta[2] = Math.max(-170, theta[2]-speed);
                break;
            case 82:	// r - snýr efri armi
			    theta[3] = Math.min(170, theta[3]+speed);
                break;
            case 84:	// t - snýr efri armi
			    theta[3] = Math.max(-170, theta[3]-speed);
                break;
         }
